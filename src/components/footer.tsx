      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            <p className="mb-4">
              Providing innovative manufacturing solutions since 2003. Your
              trusted partner for medical device fabrication.
            </p>
          ...
          >
            ...
            <form className="flex space-x-2">
              <Input
                ...
                className="bg-white/10 border-blue-500 placeholder-gray-400 flex-grow"
              />
              <Button
                type="submit"
